...
export default function CustomFolder({ params }: { params: { folder: string } }) {
          ...
          <div className="bg-background">
            <div className="grid lg:grid-cols-5">
              ...
              <div className="col-span-3 lg:col-span-4 lg:border-l">
                  ...
                  <div className="h-full px-4 py-6">
                    {selectedFolder.space !== 'compose' ? (
                      <Tabs defaultValue="unread" className="h-full space-y-6">
                        ...
                        >
                          {selectedFolder && <EmailFolder folder={params.folder} editor={editor} />}
                        </TabsContent>
                        <TabsContent
                          value="read"
                ...
                ) : <EmailFolder folder={params.folder} editor={editor} />}
              </div>
            </div>
          </div>
        </div>
